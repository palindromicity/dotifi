...
def process():
    ...
    parser.add_argument("--with-existing-dot-file", "-w", required=False,
    ...
    parser.add_argument("--output-graphviz-format", "-f", default="png",
                        ...
                        choices=["canon", "cmap", "cmapx", "cmapx_np", "dia", "dot", "fig", "gd", "gd2", "gif",
                                 ...
                                 "vrml",
                                 "vtx", "wbmp", "xdot", "xlib"])
    parser.add_argument("--output-graphviz-program", required=False, default="dot",
                        help="Graphviz layout method to use.",
                        choices=['neato', 'dot', 'twopi', 'circo', 'fdp', 'nop'])
    parser.add_argument("--output-graphviz-file", "-g",
                        required=False, default="nifi-canvas",
    ...
    parser.add_argument("--start-at-pg", "-s", required=False,
    ...
    parser.add_argument("--depth", "-d", required=False, default="-1",
